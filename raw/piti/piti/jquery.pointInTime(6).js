    ...
    piti.PitiPicker = function( piti, pickerOptions ) {
      ...
      var setDragNDrop = function() {
        ...
        pp.handleDrag = function( eventTarget, positionTop ) {
          ...
          $piti.find( '.piti_allHours li' ).removeClass( 'piti_timeSelected' );  // TODO: DEPRECATED
          $timeCell.addClass( 'piti_timeSelected' );                             // TODO: DEPRECATED
          // TODO: publish new time value
          // calculate time from pointer position
          var newTime = ( 20 * 60 * 60 * 1000 ) / h * i;
          newTime = newTime; // TODO: delete this pls */
        };
